...
public class ClienteView extends javax.swing.JFrame {
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if (row == -1) {
            ...
            id = (int) TablaDatos.getValueAt(row, 0);
    ...
    public void listar() {
        ...
        try {
            ...
            while (rs.next()) {
                cliente[0] = rs.getInt("IDCLI");
                cliente[1] = rs.getString("DNICLI");
                cliente[2] = rs.getString("NOMRES");
                cliente[3] = rs.getString("APELLIDO");
                cliente[4] = rs.getString("DIRECION");
    ...
    public void registrar() {
        ...
        String nombres = jTxtNombes.getText();  // Corrección aquí
        String apellidos = jTxtApellidos.getText();  // Corrección aquí
        ...
        try {
            String sql = "INSERT INTO CLIENTES(DNICLI, NOMRES, APELLIDO, DIRECION, CELULAR, SEXO) values('" + dni + "','" + nombres + "','" + apellidos + "','" + direccion + "','" + celular + "','" + sexo + "')";
            con = conexion.Conexion();
            st = con.createStatement();
    ...
    public void editar() {
        // No reinicies el id aquí, ya se ha asignado desde el click de la tabla
        String dni = jTxtDni.getText();
        String nombres = jTxtNombes.getText();
        String apellidos = jTxtApellidos.getText();
        String direccion = jTextAreaDireccion.getText();  // Corrección aquí
        String celular = jTxtCelular.getText();  // Corrección aquí
        if (jRadioMasculino.isSelected()) {
            sexo = "M";
        } else {
            sexo = "F";
        ...
        try {
            String sql = "UPDATE CLIENTES SET DNICLI='" + dni + "', NOMRES='" + nombres + "', APELLIDO='" + apellidos + "', DIRECION='" + direccion + "', CELULAR='" + celular + "', SEXO='" + sexo + "' WHERE IDCLI=" + id;
            con = conexion.Conexion();
            st = con.createStatement();
            st.executeUpdate(sql);
    ...
    public void eliminar() {
        ...
        if (fila == -1) {
            ...
            String sql = "DELETE FROM CLIENTES WHERE IDCLI=" + id;
            ...
            try {
                ...
                limpiarTabla(model);  // Limpiar la tabla después de eliminar
                listar();  // Volver a listar los clientes actualizados
            } catch (Exception e) {
